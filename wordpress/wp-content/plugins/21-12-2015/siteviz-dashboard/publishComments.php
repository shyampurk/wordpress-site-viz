...
$data = getPosts($pubnub,$whichComment,$pubnub_chanel_name);
function getPosts($pubnub,$whichComment,$pubnub_chanel_name){
    global $wpdb;  
    ...
    if($comments){
        ...
        $data="{".
            ...
            '}';        
             ...
             $publish_result = $pubnub->publish('demojay',$data);$pubnub_chanel_name
